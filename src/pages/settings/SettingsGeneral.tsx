    ...
    try {
      ...
      const { error } = await supabase
        ...
        .update({
          ...
          default_membership_days: Number.isNaN(defaultMembershipDays)
            ? null
            : defaultMembershipDays,
          grace_period_days: Number.isNaN(gracePeriodDays)
            ? null
            : gracePeriodDays,
        ...
        <div className="grid gap-4 md:grid-cols-2">
          ...
          <div className="flex items-center gap-2">
            <Checkbox
              id="autoSuspend"
              checked={autoSuspend}
              onCheckedChange={checked => setAutoSuspend(Boolean(checked))}
            />
            <Label htmlFor="autoSuspend">
