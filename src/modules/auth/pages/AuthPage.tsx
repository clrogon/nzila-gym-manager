    ...
    <div className="min-h-screen flex items-center justify-center bg-background p-4">
      ...
      <Card className="w-full max-w-md relative animate-fade-in">
        <div className="text-center space-y-4 mb-6">
          ...
          <div>
            <h1 className="text-3xl font-display font-bold text-foreground">GymFlow</h1>
            <p className="text-muted-foreground">Manage your gym with ease</p>
          </div>
        </div>
        ...
        <Tabs defaultValue="signin" className="space-y-6">
          ...
          <TabsContent value="signin" className="space-y-4">
            <form onSubmit={handleSignIn} className="space-y-4">
              <div>
                <Label htmlFor="signin-email" className="mb-2 block text-foreground">Email</Label>
                <TextInput
                  id="signin-email"
                  type="email"
              ...
              <div>
                <Label htmlFor="signin-password" className="mb-2 block text-foreground">Password</Label>
                <TextInput
                  id="signin-password"
                  type="password"
                  placeholder="••••••••"
            ...
            <div className="space-y-3">
              <Button color="gray" className="w-full" onClick={handleGoogleSignIn} disabled={loading}>
              ...
              <form onSubmit={handleMagicLink} className="flex gap-2">
                <TextInput
                  ...
                  className="flex-1"
                />
                <Button type="submit" color="gray" disabled={loading}>
          ...
          <TabsContent value="signup" className="space-y-4">
            <form onSubmit={handleSignUp} className="space-y-4">
              <div>
                <Label htmlFor="signup-name" className="mb-2 block text-foreground">Full Name</Label>
                <TextInput
                  id="signup-name"
                  type="text"
              ...
              <div>
                <Label htmlFor="signup-email" className="mb-2 block text-foreground">Email</Label>
                <TextInput
                  id="signup-email"
                  type="email"
                  placeholder="you@example.com"
              ...
              <div>
                <Label htmlFor="signup-password" className="mb-2 block text-foreground">Password</Label>
                <TextInput
                  id="signup-password"
                  type="password"
                  placeholder="••••••••"
